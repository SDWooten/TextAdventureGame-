...
// Sets the value of tjhe userInput to the user's entry
let userInput = prompt(q1)

// NESTED CONDITIONAL STATEMENTS
// 1st Conditional Statement
// NOTE: Prompt returns the value entered as a string. That is why double equals is used instread of triple equals (AKA Strict Equality)

if (userInput == 1) {
    userInput = prompt(q2)

    // 2nd conditional statemebnt
    if (userInput == 1) {
        userInput = prompt(q3);
